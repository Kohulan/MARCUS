    ...
    <div v-else class="segments-content">
      ...
      <div class="segments-filter-bar">
        ...
        <div class="filter-stats">
          ...
          <button class="select-all-btn" @click="selectAllVisible" :disabled="!visibleSegments.length">
      ...
      <div class="segments-grid">
        <div v-for="segment in visibleSegments" :key="segment.id" class="segment-item" :class="{
  ...
  methods: {
    ...
    processStructures() {
      ...
      this.$emit('process-structures', {
        ...
        ...this.modelOptions,
        segments: this.visibleSegments, // Use visible segments instead of all segments
    ...
    selectAllVisible() {
      if (!this.visibleSegments.length) return
      ...
      this.$emit('notification', {
        type: 'success',
        message: `Selected all ${this.visibleSegments.length} visible segments`
      })
    },

    clearSelection() {
      // Create an array of segments to deselect
      const segmentsToDeselect = this.visibleSegments.filter(segment =>
